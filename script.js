...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // キャラクタークリックで表示切替
    const characterContainer = document.getElementById('seasonalCharacterContainer');
    ...
    function openModal(dateKey, year, month, day) {
        ...
        setTimeout(() => { if (eventTitleInput) eventTitleInput.focus(); }, 100);
    }
    ...
    function renderEvents() {
        ...
        dayEvents.forEach((event, index) => {
            ...
            item.innerHTML = `
                ...
                <span class="delete-event" onclick="window.deleteEvent(event, ${index})">&times;</span>
            `;
    ...
    function handleAddEvent() {
        ...
        if (!title) {
            ...
            setTimeout(() => eventTitleInput.style.borderColor = '#f0f0f0', 1000);
            return;
        }
